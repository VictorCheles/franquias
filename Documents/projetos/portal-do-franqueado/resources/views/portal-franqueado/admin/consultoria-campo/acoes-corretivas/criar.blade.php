            ...
            <div class="box box-black box-solid">
                ...
                <div class="box-body">
                    ...
                    <div class="group-topico form-group" data-ref="0">
                        ...
                        {!! Form::text('topico[0][descricao]' , Request::get('topico.0.descricao'), ['class' => 'form-control', 'required']) !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10 col-xs-12">
                                    <div class="group-pergunta form-group">
                                        ...
                                        {!! Form::text('topico[0][pergunta][0][descricao]' , Request::get('topico.0.pergunta.0.descricao'), ['class' => 'form-control', 'required']) !!}
                                    </div>
    ...
    <script>
        function templatePergunta(topico_id, pergunta_id)
        {
            ...
            <div class="group-pergunta form-group">
                ...
                <input type="text" name="topico[`+topico_id+`][pergunta][`+pergunta_id+`][descricao]" class="form-control" required>
            </div>
            `;
        ...
        function templateTopico(id)
        {
            ...
            var template = `
                <div class="group-topico form-group" data-ref="`+ id +`">
                    ...
                    <input type="text" name="topico[`+id+`][descricao]" class="form-control" required>
                    <div style="margin-top:10px;">
                        <div class="row">
                            <div class="col-sm-1 hidden-xs">
