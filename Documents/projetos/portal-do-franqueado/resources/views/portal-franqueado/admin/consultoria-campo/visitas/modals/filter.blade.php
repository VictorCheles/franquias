            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        {!! Form::select('filter[formulario_id]' , $formularios->pluck('descricao', 'id')->toArray() , Request::input('filter.formulario_id') , ['placeholder' => 'Selecione uma opção','class' => 'form-control']) !!}
                    </div>
                    <div class="form-group col-sm-6">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        {!! Form::select('filter[status]' , \App\Models\ConsultoriaCampo\Visita::$mapStatus , Request::input('filter.loja_id') , ['placeholder' => 'Selecione uma opção','class' => 'form-control']) !!}
                    </div>
                    <div class="form-group col-sm-6">
