        ...
        <section class="col-xs-12">
            <div class="headline-row">
                <h1 class="section-title caticon sbx">
                    <img src="{{ asset('images/brand_small.png') }}"> Nova Meta
                </h1>
            </div>
        </section>
    </div>
            ...
            <div class="box box-black box-solid">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group {{ $errors->has('periodo') ? 'has-error' : '' }}">
                        ...
                        {!! Form::email('periodo' , '' , ['class' => 'form-control']) !!}
                    </div>
                    <div class="form-group {{ $errors->has('telefone') ? 'has-error' : '' }}">
                        {!! Form::label('valor', 'Valor da meta') !!}
                ...
                <div class="box-footer">
                    {!! link_to(route('clientes_loja_estabelecimento.index'), 'Cancelar', ['class' => 'btn btn-flat btn-danger pull-left']) !!}
