        ...
        <section class="col-xs-12">
            <div class="headline-row">
                <h1 class="section-title caticon sbx">
                    <img src="{{ asset('images/brand_small.png') }}"> Editar Grupo - {{ $item->nome }}
                </h1>
            </div>
        </section>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="box box-black box-solid">
                ...
                {!! Form::open(['url' => route('admin.grupos.update', $item->id)]) !!}
                                ...
                                <div class="box box-black box-solid">
                                    ...
                                    <div class="box-body">
                                        @foreach($recursos as $id => $recurso)
                                            <div class="checkbox">
                                                <label>
                                                    {!! Form::checkbox('recurso[]', $id, $default_recursos->contains($id) ? true : false, ['children' => $i]) !!} {{ $recurso }}
                                                </label>
                                            </div>
                                        @endforeach
                                    </div>
